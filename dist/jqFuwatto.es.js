...
const slideFromPosition = (options, originalPosition) => {
  ...
  if (!SLIDE.includes((_a = options == null ? void 0 : options.slide) != null ? _a : "")) {
    return ret;
  }
  if (options.slide === "left-right") {
    ret.top = originalPosition.top;
    ret.left = originalPosition.left - ((_b = options.distance) != null ? _b : DEFAULT_OPTIONS.options.distance);
  } else if (options.slide === "right-left") {
    ret.top = originalPosition.top;
    ret.left = originalPosition.left + ((_c = options.distance) != null ? _c : DEFAULT_OPTIONS.options.distance);
  } else if (options.slide === "bottom-top") {
    ret.top = originalPosition.top + ((_d = options.distance) != null ? _d : DEFAULT_OPTIONS.options.distance);
    ret.left = originalPosition.left;
  } else if (options.slide === "top-bottom") {
    ret.top = originalPosition.top - ((_e = options.distance) != null ? _e : DEFAULT_OPTIONS.options.distance);
    ret.left = originalPosition.left;
  }
  return ret;
};
...
const slideIn = ({ elem, clone, options, originalInfo }) => {
  ...
  if (clone) {
    ...
    }, { duration: (_a = options.duration) != null ? _a : 1e3, queue: false });
  }
  setTimeout(() => {
...
const show = () => {
  ...
  const targets = showElement.filter(({ positionToShow }) => currentPosition > positionToShow);
  if (targets.length) {
...
$.fn.fuwatto = Object.assign(function(options = DEFAULT_OPTIONS.options) {
